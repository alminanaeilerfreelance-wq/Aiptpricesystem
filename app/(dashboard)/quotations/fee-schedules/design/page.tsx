...
export default function DesignFeeSchedulePage() {
  ...
  if (loading) {
    return (
      <div className="flex flex-col h-full">
        <Topbar
          title="Design Fee Schedule"
          breadcrumbs={[{ label: 'Fee Schedules' }, { label: 'Design' }]}
        />
        ...
        {procedures.length === 0 ? (
          <Card>
            <p className="text-sm text-gray-500 text-center py-6">
              No Design procedures found. Add procedures first.
            </p>
          </Card>
        ) : (
          <Card padding="p-0">
                  ...
                  <tr>
                    ...
                    {procedures.map((proc) => (
                      <th
                        key={proc._id}
                        colSpan={3}
                        className="table-header text-center border-l border-border bg-orange-50 text-orange-800"
                      >
                        {proc.name}
                      </th>
                    ))}
